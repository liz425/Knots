...
public:
	...
	void GetInverse( cyMatrix2f &inverse ) { inverse=*this; inverse.Invert(); }		///< Get the inverse of this matrix
	cyMatrix2f GetInverse() { cyMatrix2f inv(*this); inv.Invert(); return inv; }	///< Get the inverse of this matrix
